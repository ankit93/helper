    ...
    <div class="rghtarea">
      <div class="contentBoxArea">
        ...
        <div class="normalContentArea">
          <p> This privacy policy sets out how VictoryNet Technologies uses and protects any information
            that you give VictoryNet Technologies when you use this website.<br/>
            <br/>
            VictoryNet Technologies is committed to ensuring that your privacy is protected.
            ...
            with this privacy statement.<br/>
            <br/>
            VictoryNet Technologies may change this policy from time to time by updating this
            page. You should check this page from time to time to ensure that you are happy
            with any changes.<br/>
            <br/>
            <span class="normalDarkText">What we collect</span> <br/>
          ...
          <span class="normalDarkText">What we do with the information we gather</span> <br/>
          ...
          <ul class="bulletArea">
            ...
            <li>We may periodically send promotional email about new products, special offers or
          ...
          <span class="normalDarkText">Security</span> <br/>
          <br/>
          We are committed to ensuring that your information is secure. In order to prevent
          unauthorized access or disclosure we have put in place suitable physical, electronic
          and managerial procedures to safeguard and secure the information we collect online.<br>
          <br/>
          <span class="normalDarkText">How we use cookies</span> <br/>
          <br/>
          A cookie is a small file which asks permission to be placed on your computer's hard
          drive. Once you agree, the file is added and the cookie helps analyze web traffic
          ...
          analyze data about web page traffic and improve our website in order to tailor it
          to customer needs. We only use this information for statistical analysis purposes
          and then the data is removed from the system. <br/>
          <br/>
          ...
          prefer. This may prevent you from taking full advantage of the website.<br>
          <br/>
          <span class="normalDarkText">Links to other websites</span> <br/>
          <br/>
          Our website may contain links to enable you to visit other websites of interest
          easily. However, once you have used these links to leave our site, you should note
          ...
          website in question.<br/>
          <br/>
          <span class="normalDarkText">Controlling your personal information</span> <br/>
          You may choose to restrict the collection or use of your personal information in
          the following ways:
          <ul class="bulletArea">
            <li>Whenever you are asked to fill in a form on the website, look for the box that you
            ...
            <li>If you have previously agreed to us using your personal information for direct marketing
              purposes, you may change your mind at any time by writing to or emailing us</li>
          </ul>
          ...
          we think you may find interesting if you tell us that you wish this to happen.<br>
          <br/>
