...
<script type="text/javascript">
	$j(document).ready(function() {
				oTable = $j('#grdData').dataTable({
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "http://<?php echo  $_SERVER['SERVER_NAME']?>/classes/dvTestimonial.php"
  ...
  <div id="leftBox">
    ...
    <div class="contentBox">
      ...
      <div class="innerContent">
	   <a href="create-testimonial.php"  style="font-weight:bold;color:#c5a393;font-size:14px;">Add New Testimonial Data</a>    
      <div style="margin-top:10px;"></div>
         ...
         <table cellpadding="0" cellspacing="0" border="0" class="serviceContainer" id="grdData" style="border:solid 1px #cccccc;width:100%;">
			...
			<th style="width:150px;" align="left">Position</th>						 
