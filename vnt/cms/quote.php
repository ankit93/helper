...
if(isset($_GET['id']))	
{	
	$msg=$objgm->deleteQuoteRecord($_GET['id']);
	if($msg =="true")
	{
...
<script type="text/javascript">
	$j(document).ready(function() 
	{
				...
				({
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "http://<?php echo $_SERVER['SERVER_NAME']?>/classes/dvQuoteclass.php"
					//http://<?php echo $_SERVER['SERVER_NAME']?>/classes/dvQuoteclass.php
					//http://localhost/VNT/classes/dvQuoteclass.php
				});
	});
</script>
<style type="text/css">
  ...
  <div id="leftBox">
    ...
    <div class="contentBox">
      <div class="contentBoxTop">
        <h3> <span id="lblTitle">Manage Quote </span> </h3>
      </div>
          ...
          <table cellpadding="0" cellspacing="0" border="0" class="serviceContainer" id="grdData" style="border:solid 1px #cccccc;width:100%;">
            <thead>
              <tr style="width:100%;padding:3px;font-weight:bold;height:28px;">
				...
				<th style="width:150px;" align="left">Company</th>
				<th style="width:140px;" align="left">Description</th>													
